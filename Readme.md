...
flowchart TD
    ...
    H[Swagger UI] --> C
    I[Claude Desktop] --> D
    J[Gemini Code Assist] --> D
    K[VSCode MCP Client] --> D
```
...
- **MCP Integration**: Pre-configured with Claude Desktop, Gemini Code Assist, and VSCode MCP Client for major AI development tools
- **Cross-Platform**: Runs on any platform supporting .NET 10

## Badges

[![.NET 10](https://img.shields.io/badge/.NET-10-512BD4?style=for-the-badge&logo=dotnet)](https://dotnet.microsoft.com/en-us/download/dotnet/10.0)
...
[![Swagger UI](https://img.shields.io/badge/Swagger%20UI-85EA2D?style=for-the-badge&logo=swagger)](https://swagger.io/tools/swagger-ui/)
...
```plaintext
TodoMCPServer/
├── .gemini/                   # config for Gemini Code Assist (MCP)
│   └── …                      # (files in this folder)
├── .vscode/                   # VS Code configuration (MCP + editor settings)
│   └── …                      # (files in this folder)
├── ClaudeDesktopConfig/       # config for Claude Desktop (MCP)
│   └── …                      # (files in this folder)
...
├── TodoService.cs             # Business logic / service layer for Todo operations
